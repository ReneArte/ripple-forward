...
const PayItForward: React.FC = () => {
  ...
  return (
    <section className="py-16 px-4 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950 dark:to-orange-950">
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto mb-12">
          {paymentOptions.map((option) => (
            <Card key={option.name} className="hover:shadow-lg transition-shadow duration-200 border-0">
