            ...
            <CardContent>
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  ...
                  name: 'Alex K.',
                  img: 18
                }].map(person => <button key={person.name} className="p-3 border-2 border-muted rounded-lg hover:border-hope-green hover:bg-hope-green/5 transition-colors text-center">
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  <Input type="text" placeholder="Search for someone by name or username..." className="pl-12 text-lg p-4 border-2 border-muted focus:border-hope-green" />
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <Input type="text" placeholder="Select or search for the person..." value={formData.title} onChange={e => setFormData({
                  ...formData,
                  title: e.target.value
                })} className="text-lg p-4 border-2 border-muted focus:border-hope-green" required />
                </div>
                ...
                <div>
                  ...
                  <Textarea placeholder="Describe the kind act and what happened. How did it impact others?" value={formData.description} onChange={e => setFormData({
                  ...formData,
                  description: e.target.value
                })} className="min-h-32 text-lg p-4 border-2 border-muted focus:border-hope-green resize-none" required />
                </div>
                ...
                <div>
                  ...
                  <Input type="text" placeholder="Tag others who were positively affected (optional)" className="text-lg p-4 border-2 border-muted focus:border-hope-green" />
                </div>
                ...
                <Button type="submit" size="lg" disabled={isSubmitting || !formData.title || !formData.description} className="w-full bg-hope-green hover:bg-hope-green-dark text-white py-4 text-lg font-medium gentle-hover">
